...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.jsx`, /* @__PURE__ */ Object.assign({ "./Pages/ChartPage.jsx": () => import("./assets/ChartPage-CkqjJrh-.js"), "./Pages/CompaignsPage.jsx": () => import("./assets/CompaignsPage-B91X6V5j.js"), "./Pages/MailsPage.jsx": () => import("./assets/MailsPage-BWZ53ZlQ.js") })),
    setup: ({ App, props }) => {
