...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(`./Pages/${name}.jsx`, /* @__PURE__ */ Object.assign({ "./Pages/ChartPage.jsx": () => import("./assets/ChartPage-CdzYV1O8.js"), "./Pages/CompaignsPage.jsx": () => import("./assets/CompaignsPage-msC2JICP.js"), "./Pages/MailsPage.jsx": () => import("./assets/MailsPage-CpMRqVoA.js") })),
    setup: ({ App, props }) => {
