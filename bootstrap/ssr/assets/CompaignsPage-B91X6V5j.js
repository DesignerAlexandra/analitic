...
import { Grid, ButtonGroup, Button, Box, Typography, Skeleton, CircularProgress } from "@mui/material";
...
const Compaigns = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs(Guest, { dateUpdateDirect: data.dateUpdateDirect, updateDirectDate, children: [
    ...
    /* @__PURE__ */ jsx("hr", {}),
    /* @__PURE__ */ jsx("br", {}),
    !loader ? /* @__PURE__ */ jsx(Box, { sx: { display: "dlex", justifyContent: "center", alignItems: "start" }, children: /* @__PURE__ */ jsx(CircularProgress, { size: 150, sx: { margin: "20px 0" } }) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
