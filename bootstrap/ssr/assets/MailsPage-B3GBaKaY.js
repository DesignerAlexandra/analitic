...
import { Grid, ButtonGroup, Button, Typography, Container, Skeleton, Alert } from "@mui/material";
      ...
      children: [
        /* @__PURE__ */ jsx(DialogContent, { children: /* @__PURE__ */ jsxs(Grid, { container: true, spacing: 2, children: [
          ...
          /* @__PURE__ */ jsxs(Grid, { item: true, xs: 8, children: [
            ...
            errAlert ? /* @__PURE__ */ jsx(Grid, { container: true, className: "card_group", children: /* @__PURE__ */ jsx(Grid, { item: true, xs: 12, children: /* @__PURE__ */ jsx(Typography, { variant: "h4", children: /* @__PURE__ */ jsx(Alert, { severity: "error", children: "Данные о пользователе отсутствуют !" }) }) }) }) : ""
          ] })
        ] }) }),
...
function TableComponent({ data }) {
  ...
  return /* @__PURE__ */ jsxs(Paper, { sx: { width: "100%", margin: "0 auto" }, children: [
    ...
    /* @__PURE__ */ jsx(ModalComponent, { dataModal, handleClose, open, skeleton, errAlert })
  ] });
}
