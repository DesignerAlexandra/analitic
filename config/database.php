...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'swagelo' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_SWAGELO'),
            'host' => env('DB_HOST_SWAGELO', '127.0.0.1'),
            'port' => env('DB_PORT_SWAGELO', '3306'),
            'database' => env('DB_DATABASE_SWAGELO', 'forge'),
            'username' => env('DB_USERNAME_SWAGELO', 'forge'),
            'password' => env('DB_PASSWORD_SWAGELO', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'hylok' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_HYLOK'),
            'host' => env('DB_HOST_HYLOK', '127.0.0.1'),
            'port' => env('DB_PORT_HYLOK', '3306'),
            'database' => env('DB_DATABASE_HYLOK', 'forge'),
            'username' => env('DB_USERNAME_HYLOK', 'forge'),
            'password' => env('DB_PASSWORD_HYLOK', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
